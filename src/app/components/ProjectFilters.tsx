...
export default function ProjectFilters({ 
 ...
 return (
 <div className="bg-graphite border border-chrome-line rounded-xl p-4 mb-6">
 {/* Filter Header */}
 ...
 <label htmlFor="sort" className="text-sm text-silver ">
 Sort by:
 </label>
 <select
 id="sort"
 ...
 className="px-3 py-1 bg-void border border-chrome-line rounded-md text-sm text-platinum focus:ring-2 focus:ring-accent focus:border-transparent"
 >
 ...
 : 'bg-graphite text-silver hover:bg-slate-raised '
 }`}
 >
 ⭐ Featured Only
 </button>
 ...
 className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium hover:bg-blue-200 transition-colors flex items-center gap-1"
 >
 Advanced Filters
 <svg 
 ...
 >
 <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-4 border-t border-chrome-line ">
 {/* Categories */}
 <div>
 <h4 className="font-medium text-platinum mb-3">Categories</h4>
 ...
 className="rounded border-chrome-line text-accent focus:ring-accent "
 />
 ...
 {/* Status */}
 <div>
 <h4 className="font-medium text-platinum mb-3">Status</h4>
 <div className="space-y-2">
 ...
 {/* Technologies */}
 <div>
 <h4 className="font-medium text-platinum mb-3">Technologies</h4>
