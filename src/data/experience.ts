...
export const experience: ExperienceItem[] = [
  {
    ...
    startDate: '2026-07',
    period: '2026',
    summary: 'Built automation pipelines in healthcare as founding engineer.',
    highlights: [
      'Built health-automation infrastructure from the ground up as the founding engineer.',
      'Designed agentic pipelines that moved clinical and operational data safely across systems.',
    ],
